StartupEvents.registry("creative_mode_tab", (event) => {
	...
	addCreativeTab("io_block")
		...
		.content(() => {
			return [
				Ingredient.of("#cmi:io_debug_block").getItemIds()
			]
		})
	...
	addCreativeTab("materials")
		...
		.content(() => {
			return [
				Ingredient.of("#cmi:metals").getItemIds(),
				Ingredient.of("#cmi:ores").getItemIds(),
				Ingredient.of("#cmi:raw_metals").getItemIds()
			]
		})
	...
	addCreativeTab("developers")
		...
		.content(() => {
			return [
				Ingredient.of("#cmi:dev_doll").getItemIds()
			]
		})
